// carousel-hero — full-bleed hero carousel variant of carousel-detail.
// Rotation/indicator/arrow behavior is identical to carousel-detail; only the
// class names (and the styling in carousel-hero.css) differ. Each slide has an
// image cell + a content cell (heading, description, CTA) rendered as an overlay.

// This scaffold's aem.js does not export fetchPlaceholders; the block only uses
// it to look up aria-label strings, all of which have hardcoded fallbacks below.
...
export default async function decorate(block) {
  ...
  // Hero carousel always shows indicator dots and prev/next arrows,
  // even when a single slide is authored.
